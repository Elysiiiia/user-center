...
import com.example.demo.model.domain.request.TeamAddRequest;
...
public class TeamController {
    ...
    public BaseResponse<List<TeamUserVO>>  listTeams(TeamQuery teamQuery,HttpServletRequest request) {
        ...
        try{
            ...
            Set<Long> hasJoinTeam=userTeamList.stream().map(UserTeam::getTeamId).collect(Collectors.toSet());
            teamlist.forEach(team->
            {
                boolean hasJoin=hasJoinTeam.contains(team.getId());
    ...
    @PostMapping("/join")
    public BaseResponse<Boolean> joinTeam(@RequestBody JoinTeamRequest joinTeamReaquest, HttpServletRequest request) {
        if(joinTeamReaquest==null){
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        User loginUser=userService.getLoginUser(request);
        Boolean result = teamService.joinTeam(joinTeamReaquest,loginUser);
    ...
    public BaseResponse<Boolean> quitTeam(@RequestBody TeamQuitRequest teamQuitRequest, HttpServletRequest request) {
        ...
        {
            throw new BusinessException(ErrorCode.PARAMS_ERROR,"离队请求为空");
        }
        User loginUser=userService.getLoginUser(request);
